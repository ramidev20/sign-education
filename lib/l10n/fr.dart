const Map<String, String> fr = {
  ...
  'strategy_json.label': 'JSON de la strategie',

  'strategy_visual.save': 'Enregistrer',
  'strategy_visual.cancel': 'Annuler',
  'strategy_visual.add': 'Ajouter',
  'strategy_visual.edit': 'Modifier',
  'strategy_visual.delete': 'Supprimer',
  'strategy_visual.error': 'Erreur',
  'strategy_visual.save_failed': "Impossible d'enregistrer",
  'strategy_visual.title': 'Titre',
  'strategy_visual.description': 'Description',

  'strategy_visual.timeline.title': 'Editeur de chronologie',
  'strategy_visual.timeline.edit_event': "Modifier l'evenement",
  'strategy_visual.timeline.date': 'Date',
  'strategy_visual.timeline.event': 'Evenement',
  'strategy_visual.timeline.title_label': 'Titre de la chronologie',
  'strategy_visual.timeline.sort_by_date': 'Trier par date',
  'strategy_visual.timeline.date_placeholder': 'AAAA/MM/JJ',
  'strategy_visual.timeline.new_event': 'Nouvel evenement',

  'strategy_visual.hierarchy.title': 'Editeur de hierarchie',
  'strategy_visual.hierarchy.edit_level': 'Modifier le niveau',
  'strategy_visual.hierarchy.new_level': 'Nouveau niveau',

  'strategy_visual.colored_cards.title': 'Editeur de cartes colorees',
  'strategy_visual.colored_cards.edit_card': 'Modifier la carte',
  'strategy_visual.colored_cards.type': 'Type',
  'strategy_visual.colored_cards.color_hex': 'Couleur (HEX ex. #60A5FA)',
  'strategy_visual.colored_cards.content': 'Contenu',
  'strategy_visual.colored_cards.new_card': 'Nouvelle carte',
  'strategy_visual.colored_cards.default_type': 'Concept',

  'strategy_visual.journalistic.title': 'Editeur de questions journalistiques',
  'strategy_visual.journalistic.type': 'Type',
  'strategy_visual.journalistic.question': 'Question',
  'strategy_visual.journalistic.answer': 'Reponse',
  'strategy_visual.journalistic.type_prefix': 'Type : {t}',
  'strategy_visual.journalistic.edit_question': 'Modifier la question',
  'strategy_visual.journalistic.new_question': 'Nouvelle question',
  'strategy_visual.journalistic.type.what': 'Quoi',
  'strategy_visual.journalistic.type.when': 'Quand',
  'strategy_visual.journalistic.type.where': 'Ou',
  'strategy_visual.journalistic.type.why': 'Pourquoi',
  'strategy_visual.journalistic.type.how': 'Comment',
  'strategy_visual.journalistic.type.who': 'Qui',

  'strategy_visual.triangle.title': 'Editeur de triangle',
  'strategy_visual.triangle.angle_name': "Nom de l'angle",
  'strategy_visual.triangle.optional_description': 'Description (optionnel)',
  'strategy_visual.triangle.add_example': 'Ajouter un exemple',
  'strategy_visual.triangle.add_example_title': 'Ajouter un exemple',
  'strategy_visual.triangle.no_examples_yet': "Pas d'exemples pour le moment.",
  'strategy_visual.triangle.help':
      "Appuyez sur un angle pour le modifier (nom, titre, description, exemples et couleur).",

  'strategy_visual.story.title': "Editeur d'histoire educative",
  'strategy_visual.story.add_character_title': 'Ajouter un personnage',
  'strategy_visual.story.story_title': "Titre de l'histoire",
  'strategy_visual.story.place_time': 'Lieu / temps',
  'strategy_visual.story.no_characters_yet': 'Aucun personnage pour le moment.',
  'strategy_visual.story.add_paragraph': 'Ajouter un paragraphe',
  'strategy_visual.story.paragraph_n': 'Paragraphe {n}',
  'strategy_visual.story.moral': 'Morale',

  'strategy_visual.six_hat.title': 'Editeur des six chapeaux',
  'strategy_visual.six_hat.white': 'Chapeau blanc',
  'strategy_visual.six_hat.red': 'Chapeau rouge',
  'strategy_visual.six_hat.black': 'Chapeau noir',
  'strategy_visual.six_hat.yellow': 'Chapeau jaune',
  'strategy_visual.six_hat.green': 'Chapeau vert',
  'strategy_visual.six_hat.blue': 'Chapeau bleu',
  'strategy_visual.six_hat.hint': 'Ecrivez le contenu pour {hat}',

  'strategy_visual.comparison.title': 'Editeur de tableau de comparaison',
  'strategy_visual.comparison.add_column': 'Ajouter une colonne',
  'strategy_visual.comparison.column_name': 'Nom de colonne',
  'strategy_visual.comparison.edit_criterion': 'Modifier le critere',
  'strategy_visual.comparison.add_criterion': 'Ajouter un critere',
  'strategy_visual.comparison.new_criterion': 'Nouveau critere',
  'strategy_visual.comparison.default_option_1': 'Option 1',
  'strategy_visual.comparison.default_option_2': 'Option 2',
  'strategy_visual.comparison.edit_cell_title': 'Modifier : {criterion} / {option}',
  'strategy_visual.comparison.tap_to_edit_cells': 'Appuyez pour modifier les cellules',
  'strategy_visual.comparison.edit_criterion_tooltip': 'Modifier le critere',
  'strategy_visual.comparison.delete_criterion_tooltip': 'Supprimer le critere',

  'strategy_visual.mindmap.title': 'Editeur de carte mentale',
  'strategy_visual.mindmap.edit_text': 'Modifier le texte',
  'strategy_visual.mindmap.auto_layout': 'Mise en page auto',
  'strategy_visual.mindmap.help':
      'La carte est organisee automatiquement de haut en bas. Double-cliquez pour modifier le texte, utilisez (+) pour ajouter un enfant, et faites glisser "Lien" pour reconnecter une branche.',

  'lesson_view.quick.view': 'Voir',
  'lesson_view.quick.visual_edit': 'Edition visuelle',
  'lesson_view.quick.regenerate': 'Regenerer',
  'lesson_view.quick.delete': 'Supprimer',
  'lesson_view.teacher_card.subtitle':
      'Gerez le cours et les strategies depuis un seul endroit.',
  'lesson_view.teacher_card.add_strategy': 'Nouvelle strategie',
  'lesson_view.teacher_card.edit_lesson': 'Modifier le cours',
  ...
  'subject.islamic': 'Education islamique',
  'subject.computer_science': 'Informatique',
  'subject.biology': 'Biologie',
  'subject.history_geography': 'Histoire et geographie',
};
